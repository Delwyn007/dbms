...
def Database():
    ...
    cursor.execute(
        "CREATE TABLE IF NOT EXISTS STUD_REGISTRATION (STU_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, STU_NAME TEXT, STU_AGE TEXT, STU_CONTACT TEXT, STU_EMAIL TEXT, STU_ROLLNO TEXT, STU_BRANCH TEXT)")
...
def DisplayForm():
    ...
    global tree
    global SEARCH
    global name,age,contact,email,rollno,branch
    SEARCH = StringVar()
    name = StringVar()
    age = StringVar()
    contact = StringVar()
   ...
   #setting scrollbar
    ...
    tree = ttk.Treeview(MidViewForm,columns=("Student Id", "Name", "Age", "Contact", "Email", "Rollno", "Branch"),
...
def register():
    ...
    if name1=='' or age1==''or con1==''or email1=='' or rol1==''or branch1=='':
        tkMessageBox.showinfo("Warning","fill the empty field!!!")
    else:
        #execute query
        conn.execute('INSERT INTO STUD_REGISTRATION (STU_NAME,STU_AGE,STU_CONTACT,STU_EMAIL,STU_ROLLNO,STU_BRANCH) \
              VALUES (?,?,?,?,?,?)',(name1,age1,con1,email1,rol1,branch1));
        conn.commit()
